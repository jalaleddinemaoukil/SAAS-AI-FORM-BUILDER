      ...
      <div className='flex justify-between items-center '>
        ...
        <div className='flex gap-2'>
          <Link href={'/aiform/'+record?.id} target='_blank'>
            <Button className='rounded text-white flex gap-2'><SquareArrowOutUpRight className='h-5 w-5'/> Live Preview</Button>
          </Link>
          <RWebShare
            data={{
        ...
        >
 <Button className='rounded text-white flex gap-2 bg-green-600 hover:bg-green-500'><Share2/> Share</Button>
        </RWebShare>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-5'>
            ...
            <div className='md:col-span-2 border rounded p-5  flex items-center justify-center'
            style={{      
